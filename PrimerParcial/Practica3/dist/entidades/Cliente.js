...
let Cliente = (() => {
    ...
    let _classThis;
    let _id_cliente_decorators;
    let _id_cliente_initializers = [];
    let _id_cliente_extraInitializers = [];
    ...
    var Cliente = _classThis = class {
        constructor() {
            this.id_cliente = __runInitializers(this, _id_cliente_initializers, void 0);
            this.nombre = (__runInitializers(this, _id_cliente_extraInitializers), __runInitializers(this, _nombre_initializers, void 0));
    ...
    __setFunctionName(_classThis, "Cliente");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_cliente_decorators = [PrimaryGeneratedColumn()];
        _nombre_decorators = [Column()];
        _correo_decorators = [Column()];
        _telefono_decorators = [Column()];
        __esDecorate(null, null, _id_cliente_decorators, { kind: "field", name: "id_cliente", static: false, private: false, access: { has: obj => "id_cliente" in obj, get: obj => obj.id_cliente, set: (obj, value) => { obj.id_cliente = value; } }, metadata: _metadata }, _id_cliente_initializers, _id_cliente_extraInitializers);
        ...
        Cliente = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Cliente = _classThis;
})();
export { Cliente };
