...
https://[tu-proyecto].supabase.co/functions/v1/webhook-externalnotifier
...
curl -X POST https://tu-proyecto.supabase.co/functions/v1/webhookevent-logger \
 -H "Content-Type: application/json" \
...
Sistema	se	recupera	
correctamente.
Nota:	Se	permite	utilizar	librerías	de	terceros	para	facilitar	la	implementación	(ej.	nestjsthrottler,	bull,	drivers	de	CDC),	siempre	que	se	explique	su	configuración	y	funcionamiento	
en	la	documentación.
...
• Transactional	Outbox	Pattern:	https://microservices.io/patterns/data/transactionaloutbox.html
• Idempotent	Consumer:	https://microservices.io/patterns/communicationstyle/idempotent-consumer.html
